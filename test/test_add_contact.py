...
class add_contact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.login(wd)
        self.add_contact_fill_form(wd, Person("John", "Doe", "paramount", "23168 CA, sunbeach blvd", "555111000", "1980"))
        self.logout(wd)
    ...
    def add_contact_fill_form(self, wd, Person):
        ...
        wd.find_element_by_name("firstname").send_keys(Person.firstname)
        ...
        wd.find_element_by_name("home").send_keys(Person.home_phone_num)
        ...
        wd.find_element_by_name("byear").send_keys(Person.year)
